...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Sidhux3;Eren bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
    ...
    HEROKU: {
        ...
        APP_NAME: process.env.HEROKU_APP_NAME || 'Sidhux3'
    },
    DATABASE_URL: DATABASE_URL,
    DATABASE: DATABASE_URL === './bot.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
    SUDO: process.env.SUDO || '919207852915,0',
